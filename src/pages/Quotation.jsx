...
const Quotation = () => {
    ...
    useEffect(() => {
        const getBalance = async () => {
            const response = await fetch(
                `https://calinao-api-production.up.railway.app/api/balance/${reservation_id}`
            );
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            const response = await fetch(
                "https://calinao-api-production.up.railway.app/api/transaction",
                {
                    method: "POST",
            ...
            if (response.ok) {
                try {
                    const response2 = await fetch(
                        `https://calinao-api-production.up.railway.app/api/update-reservation-status/${reservation_id}`,
                        {
                            method: "PATCH",
                            headers: {
    ...
    useEffect(() => {
        const getReservationDetails = async () => {
            const response = await fetch(
                `https://calinao-api-production.up.railway.app/api/reservations/${reservation_id}`
            );
            const res = await response.json();

            const response2 = await fetch(
                `https://calinao-api-production.up.railway.app/api/event/${res.event_id}`
            );
            const res2 = await response2.json();

            const response3 = await fetch(
                `https://calinao-api-production.up.railway.app/api/adds_on/${reservation_id}`
            );
            ...
            const response5 = await fetch(
                `https://calinao-api-production.up.railway.app/api/reservation_food/${reservation_id}`
            );
        ...
        try {
            ...
            if (newStatus === "Approve") {
                response = await fetch(
                    `https://calinao-api-production.up.railway.app/api/update-reservation/${reservation_id}`,
                    {
                        method: "PATCH",
                        body: JSON.stringify(data),
                        headers: {
                ...
                response = await fetch(
                    `https://calinao-api-production.up.railway.app/api/update-status/${reservation_id}`,
                    {
                        method: "PATCH",
