...
const Dashboard = () => {
        ...
        const getStatus = async () => {
            try {
                const response = await fetch(
                    "https://calinao-api-production.up.railway.app/api/status_count"
                );
    ...
    useEffect(() => {
        const getProfit = async () => {
            try {
                const response = await fetch(
                    "https://calinao-api-production.up.railway.app/api/payment_amount"
                );
        ...
        const getClientCount = async () => {
            try {
                const response = await fetch(
                    "https://calinao-api-production.up.railway.app/api/client_count"
                );
        ...
        const getMenuCount = async () => {
            try {
                const response = await fetch(
                    "https://calinao-api-production.up.railway.app/api/menu_count"
                );
        ...
        const fetchMonthlyProfit = async (month) => {
            try {
                const response = await fetch(
                    `https://calinao-api-production.up.railway.app/api/transaction_sum/${month}`
                );
